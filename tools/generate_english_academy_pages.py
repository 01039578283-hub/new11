...
# ---------------------------------------------------------------------------
# content banks (freshly written for 온담학습 / 영어학원 — this category spans
# all grade levels (초등~고등), themed around 어휘·문법·독해·듣기말하기·서술형.
# Informed by 상담방식.txt, FAQ.txt (영어 관련 문항), 학부모 후기.txt,
# 경쟁사분석, and "영어학원 원고.xlsx" (themes reused, wording rewritten,
...
FAQ_OPENER_BANK: list[tuple[str, str]] = [
    ...
    ("{title}에서는 처음부터 문법을 배우나요?",
     "학생의 현재 어휘와 독해 수준에 따라 문법부터 시작할 수도, 독해 위주로 진행할 수도 있습니다."),
...
CHECKLIST_BANK: list[tuple[str, str]] = [
    ("어휘·독해 수준", "학년에 맞는 핵심 어휘와 독해력을 어느 정도 갖추고 있는지 살펴봅니다."),
...
REVIEW_BANK: list[str] = [
    ...
    "서술형을 무서워했는데 짧은 문장부터 완성하는 연습으로 좋아졌습니다.",
    "듣기, 말하기까지 함께 챙겨주셔서 발음이 자연스러워졌습니다.",
    "학교 진도에 맞춰 준비해 주셔서 점수가 꾸준히 유지됩니다.",
    "아이가 어느 부분에서 헤매는지 선생님이 콕 집어 알려주십니다.",
    "영어를 싫어했는데 쉬운 지문부터 시작해 흥미를 붙였습니다.",
    "매일 할 수 있는 분량이라 꾸준히 이어가고 있습니다.",
    "다니던 곳을 옮겼는데 예전 진도를 살펴보고 이어서 진행해 주셨습니다.",
    "문법 용어를 어려워했는데 예문으로 설명해 주셔서 이해가 빨라졌습니다.",
    "틀린 문제를 따로 모아 관리해 주셔서 반복되는 실수가 줄었습니다.",
    "상담 때 과장 없이 정확하게 짚어주셔서 믿음이 갔습니다.",
    "고등학교 영어를 미리 준비할 수 있어서 든든합니다.",
    "처음 진단할 때 편안한 분위기라 부담이 적었습니다.",
    "영어에 자신감이 없던 아이가 스스로 손을 들고 말합니다.",
    "소수 인원이라 질문하기 부담스럽지 않다고 합니다.",
    "늦게 시작해서 걱정했는데 생각보다 빠르게 적응하고 있습니다.",
    "학습지만 하다가 학원에 다니며 독해력이 늘었습니다.",
    "수능 대비를 위해 실전 지문도 함께 봐주셔서 만족스럽습니다.",
    "나이 차이 나는 두 아이를 각각 다르게 관리해 주셔서 만족합니다.",
    "발음이 걱정이었는데 반복 연습으로 많이 좋아졌습니다.",
    "시험이 다가오면 확실히 관리가 더 촘촘해지는 게 느껴집니다.",
    "상담 때마다 다음에 무엇을 볼지 구체적으로 알려주셔서 좋습니다.",
    "단어 시험을 반복해서 이제 암기하는 요령이 생겼습니다.",
    "기초부터 차근차근 봐주셔서 실력이 자연스럽게 늘었습니다.",
]

COMPARE_ROWS: list[dict[str, tuple[str, str]]] = [
    {"label": "실력 진단", "A": ("나이만 보고 반 배정", "어휘·독해 수준부터 확인"),
     "B": ("점수만 보고 끝", "어디서 막혔는지 구체적으로 확인")},
    {"label": "문법 지도", "A": ("용어 암기 위주", "예문으로 규칙 적용 훈련"),
...
SUMMARY_INTROS: list[str] = [
    "{local} 학생에게 필요한 영어 관리는 단어량을 늘리는 것보다 지금 어휘와 독해 중 어디가 부족한지 먼저 확인하는 것입니다.",
    "{local}에서 영어학원을 고르실 때는 어휘, 문법, 독해 중 지금 필요한 부분이 무엇인지부터 살펴보시는 것이 좋습니다.",
    "{local} 학생마다 영어를 어려워하는 지점과 학년별 목표가 다르기 때문에, 같은 학년이라도 먼저 봐야 할 부분은 달라질 수 있습니다.",
]

MANUSCRIPT_INTRO: list[str] = [
    "영어는 학년이 올라갈수록 어휘와 독해의 기초가 다음 단계의 문법과 서술형까지 영향을 미칩니다. 지금 단계에서 부족한 부분을 채우지 않으면 다음 학년에서 계속 부담이 쌓일 수 있습니다.",
    "단어를 많이 아는 것과 문장을 해석하는 것은 다른 능력입니다. 단어 뜻만 외우기보다 문장 속에서 자연스럽게 만나는 경험이 필요합니다.",
    "말하기를 부끄러워하는 학생일수록 실수해도 괜찮은 분위기에서 반복해서 소리 내어 말해보는 연습이 중요합니다.",
    "고등 영어는 중등 영어의 어휘와 독해 기초 위에 세워집니다. 지금 어휘와 문장 구조를 다져두면 이후 심화 지문을 배울 때 훨씬 수월해집니다.",
    "학생마다 영어에서 막히는 지점이 다릅니다. 어휘인지, 문법인지, 독해인지부터 구분하면 훨씬 효율적으로 도울 수 있습니다.",
    "문법·독해·어휘 중 어디서 실수가 반복되는지 나누어 살펴보면, 막연히 문제를 더 푸는 것보다 훨씬 효율적으로 개선할 수 있습니다.",
]

MANUSCRIPT_OUTRO: list[str] = [
    "학원을 고르실 때는 화려한 커리큘럼보다, 학생의 현재 어휘와 독해 수준을 얼마나 구체적으로 봐주는지를 기준으로 삼으시길 권합니다.",
    "영어 점수보다 먼저 확인해야 할 것은 학생이 스스로 문장을 해석하고 설명할 수 있는지입니다.",
    "상담에서는 곧바로 결정하지 않으셔도 됩니다. 지금 학생에게 필요한 방향을 먼저 편하게 들어보시길 권합니다.",
    "영어 학습은 한 번에 완성되지 않습니다. 어휘, 문법, 독해를 오가며 조금씩 쌓아가는 과정이라는 점을 기억해 주세요.",
    "무엇보다 학생이 영어를 부담스러워하지 않는지가 꾸준한 학습으로 이어지는 데 가장 중요합니다.",
    "지금 당장의 단어 시험 점수보다, 스스로 문장을 해석해 보려는 습관이 자리 잡고 있는지를 함께 지켜봐 주시길 바랍니다.",
]
...
def local_page(row: dict[str, str], idx: int, rep_image: str, all_rows: list[dict[str, str]]) -> str:
    ...
    description = f"{region} {district} {local} 학생을 위한 {CATEGORY} 안내입니다. 어휘·문법·독해 진단, 오답 관리, 학년별 학습 우선순위를 상담 전에 확인할 수 있습니다."
    ...
    ld = {
        ...
        "@graph": [
            ...
            },
            {
                ...
                "@id": org_id,
                "name": title,
                "alternateName": [SITE_NAME, center, f"{local} 영어 학습관리"],
                "url": canonical,
                ...
                "knowsAbout": ["어휘", "문법", "독해", "듣기 말하기", "학습 습관 관리", "학습 상담"],
                "makesOffer": [
                    {"@type": "Offer", "itemOffered": {"@type": "Service", "name": f"{local} 영어 진단 상담", "serviceType": "TutoringService"}},
                    {"@type": "Offer", "itemOffered": {"@type": "Service", "name": f"{local} 어휘·문법 관리", "serviceType": "TutoringService"}},
                    {"@type": "Offer", "itemOffered": {"@type": "Service", "name": f"{local} 독해·듣기말하기 관리", "serviceType": "TutoringService"}},
                ],
            ...
            },
            {
                ...
                "description": f"{local} 학생의 어휘, 문법, 독해, 듣기말하기를 함께 진단하고 학년별 우선순위에 맞춰 관리합니다.",
                "provider": {"@id": org_id},
                "areaServed": {"@type": "Place", "name": local},
                ...
                "mentions": mentions,
                "makesOffer": [
                    {"@type": "Offer", "itemOffered": {"@type": "Service", "name": f"{local} 어휘·문법 진단"}},
                    {"@type": "Offer", "itemOffered": {"@type": "Service", "name": f"{local} 독해 관리"}},
                    {"@type": "Offer", "itemOffered": {"@type": "Service", "name": f"{local} 듣기말하기 관리"}},
                ],
            },
            {
                "@type": "FAQPage",
    ...
    badge_row = f'<div class="badge-row"><span>{esc(region)}</span><span>{esc(district)}</span><span>{esc(CATEGORY)}</span><span>어휘·문법·독해</span></div>'
    ...
    summary_section = f"""    <section class="section">
      ...
      <div class="card-grid">
        <article class="info-card"><span class="tag">01</span><h3>어휘·독해 진단</h3><p>어휘력, 문법 적용, 독해 중 지금 어디가 부족한지 먼저 나누어 확인합니다.</p></article>
    ...
    fit_section = f"""    <section class="section">
      ...
      <div class="card-grid">
        <article class="info-card"><span class="tag">지역</span><h3>{esc(region)} {esc(district)} {esc(local)}</h3><p>{esc(local)} 생활권 학생의 학교 진도와 눈높이에 맞춰 영어 관리 방향을 상담합니다.</p></article>
        <article class="info-card"><span class="tag">학년</span><h3>초1~고3, 전 학년 상담 가능</h3><p>학년과 목표에 따라 어휘, 문법, 독해 중 시작 지점을 다르게 잡습니다.</p></article>
        <article class="info-card"><span class="tag">추천</span><h3>이런 학생에게 추천</h3><p>단어는 아는데 독해가 약한 학생, 문법을 적용하지 못하는 학생, 영어를 처음 시작하는 학생에게 적합합니다.</p></article>
        {linked_schools}
      </div>
    ...
    compare_section = f"""    <section class="section">
      <div class="section-head">
        ...
        <h2>{esc(local)} 영어학원, 무엇이 다른가요</h2>
        <p class="lead">일반적인 학원 운영 방식과 {esc(SITE_NAME)}의 영어 관리 방식을 같은 기준으로 비교했습니다.</p>
      </div>
  ...
  <main>
    <section class="page-hero">
      ...
      <p class="eyebrow">ENGLISH COACHING</p>
      <h1>{esc(title)}</h1>
...
def category_hub(rows: list[dict[str, str]]) -> None:
  ...
  <main>
    <section class="page-hero">
      ...
      <p class="eyebrow">ENGLISH ACADEMY DIRECTORY</p>
      <h1>{esc(CATEGORY)}</h1>
      <p class="lead">지역별 영어 상담 기준을 한눈에 찾을 수 있도록 정리했습니다. 각 페이지에는 지역·학년·추천학생, 학교 참고 정보, FAQ, 학부모 후기, 근처 학원페이지가 함께 구성됩니다.</p>
      <div class="hero-actions">
        <a class="btn btn-primary" href="tel:{PHONE_DISPLAY}">전화 상담하기</a>
        <a class="btn btn-ghost" href="../../상담문의/index.html">상담문의</a>
      </div>
    ...
    <section class="section">
      <div class="section-head">
        ...
        <h2>{esc(SITE_NAME)}은 영어를 이렇게 관리해요</h2>
        <p class="lead">단어량을 늘리기보다, 지금 학생이 어휘·문법·독해 중 어디에서 막히는지부터 확인해요. 상담에서 시작해 진단, 오답 관리, 학년별 우선순위까지 이어갑니다.</p>
      </div>
      <div class="stepper">
        <article class="step">
        ...
        <article class="step">
          ...
          <div class="step-body"><h3>진단</h3><p>어휘, 문법, 독해 중 지금 어디부터 시작해야 할지 확인합니다.</p></div>
        </article>
        <article class="step">
